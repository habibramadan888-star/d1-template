...
Generated: 2026-05-26T15:24:56.142Z
...
| audit logs require manual production mapping        | owner           | audit_logs                     | MANUAL_REQUIRED         | MANUAL_REQUIRED | MANUAL_REQUIRED | Staging compatibility columns exist, but production audit attribution needs review. |
| entry events require manual production mapping      | employee        | entry_events                   | MANUAL_REQUIRED         | MANUAL_REQUIRED | MANUAL_REQUIRED | Entry event scope needs live write-path review before production.                   |
