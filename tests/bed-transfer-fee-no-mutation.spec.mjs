...
test("fee ledger Bed Transfer writes only event, audit, and idempotency anchors", async () => {
  ...
  assert.match(handler, /await audit\(env,user,"employee\.bed_transfer\.create"/);
