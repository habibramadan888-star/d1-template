...
async function harness({ migration = true, failRegistry = false, uuids = [STAY_UUID, LINK_UUID] } = {}) {
  ...
  vm.runInContext([
    ...
    functionBlock(source, "arrearsPaymentInputRows"),
    functionBlock(source, "arrearsPaymentForbiddenServerFieldFailure"),
    functionBlock(source, "canonicalFinanceProjectionZeroTotals"),
    functionBlock(source, "canonicalFinanceProjectionRoundTotals"),
    functionBlock(source, "canonicalFinanceProjectionPaymentMethod"),
    functionBlock(source, "canonicalFinanceProjectionAmount"),
    functionBlock(source, "canonicalFinanceProjectionEventType"),
    functionBlock(source, "canonicalFinanceProjectionAddInflow"),
    functionBlock(source, "canonicalFinanceProjectionAddOutflow"),
    functionBlock(source, "canonicalFinanceProjectionApplyAnchor"),
    functionBlock(source, "qaAcceptanceFinanceComparable"),
    functionBlock(source, "canonicalSessionSummaryEntryIdentity"),
    functionBlock(source, "canonicalSessionSummaryNormalizeAnchor"),
    functionBlock(source, "calculateCanonicalSessionSummary"),
    functionBlock(source, "canonicalSessionSummaryClientDiagnostic"),
    functionBlock(source, "canonicalSessionSummaryWithClientDiagnostic"),
    functionBlock(source, "canonicalSessionSummaryPersistenceFields"),
