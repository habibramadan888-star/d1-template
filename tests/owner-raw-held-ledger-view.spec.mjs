...
test("raw-held Owner detail renders the employee Ledger while retaining full audit evidence", async () => {
  ...
  const session = {
    ...
    entries: [
      { event_type: "rent", type: "R", room: "848", amount: 750, paid: 750, due: 750, tag: "O", payment_method: "cash", created_at: "2026-07-31T01:31:00+04:00", event_id: "rent-848", ingestion_status: "ACCEPTED", projection_status: "HELD_FOR_REVIEW" },
