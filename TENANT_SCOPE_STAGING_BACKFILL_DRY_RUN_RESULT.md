...
Generated: 2026-05-26T06:51:15.277Z
...
| ------------------------- | --------- | ---------- | ----------- | ------------ | ------------------ | -------------------- | --------------------- | --------------------------------------------- | -------------- | -------------------------------------------------------------------------------- |
| active_sessions           | 4         | yes        | no          | no           | 4                  | 0                    | 0                     | DRAFT_BACKFILL_REQUIRED_AFTER_SCHEMA_APPROVAL | LEGACY_WARNING | Legacy-scoped table needs approved schema/backfill task; no write generated now. |
| app_settings              | 0         | yes        | no          | no           | 0                  | 0                    | 0                     | DRAFT_BACKFILL_REQUIRED_AFTER_SCHEMA_APPROVAL | LEGACY_WARNING | Legacy-scoped table needs approved schema/backfill task; no write generated now. |
| arrear_tasks              | 7         | yes        | no          | no           | 7                  | 0                    | 0                     | DRAFT_BACKFILL_REQUIRED_AFTER_SCHEMA_APPROVAL | LEGACY_WARNING | Legacy-scoped table needs approved schema/backfill task; no write generated now. |
| arrears                   | 0         | yes        | no          | no           | 0                  | 0                    | 0                     | DRAFT_BACKFILL_REQUIRED_AFTER_SCHEMA_APPROVAL | LEGACY_WARNING | Legacy-scoped table needs approved schema/backfill task; no write generated now. |
| audit_logs                | 7         | yes        | no          | no           | 7                  | 0                    | 0                     | DRAFT_BACKFILL_REQUIRED_AFTER_SCHEMA_APPROVAL | LEGACY_WARNING | Legacy-scoped table needs approved schema/backfill task; no write generated now. |
| deposit_ledger            | 0         | yes        | no          | no           | 0                  | 0                    | 0                     | DRAFT_BACKFILL_REQUIRED_AFTER_SCHEMA_APPROVAL | LEGACY_WARNING | Legacy-scoped table needs approved schema/backfill task; no write generated now. |
| entry_events              | 5         | yes        | no          | no           | 5                  | 0                    | 0                     | DRAFT_BACKFILL_REQUIRED_AFTER_SCHEMA_APPROVAL | LEGACY_WARNING | Legacy-scoped table needs approved schema/backfill task; no write generated now. |
...
| sessions                  | 1         | yes        | no          | no           | 1                  | 0                    | 0                     | DRAFT_BACKFILL_REQUIRED_AFTER_SCHEMA_APPROVAL | LEGACY_WARNING | Legacy-scoped table needs approved schema/backfill task; no write generated now. |
| transactions              | 3         | yes        | no          | no           | 3                  | 0                    | 0                     | DRAFT_BACKFILL_REQUIRED_AFTER_SCHEMA_APPROVAL | LEGACY_WARNING | Legacy-scoped table needs approved schema/backfill task; no write generated now. |
