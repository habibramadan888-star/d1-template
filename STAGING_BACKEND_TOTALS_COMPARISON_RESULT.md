...
Generated: 2026-05-25T20:57:03.745Z
...
| legacy decimal / fils conversion                          | 1 transaction rows          | 13 warnings / 0 errors                            | 0.00  | LEGACY_WARNING  | Legacy decimal values are parsed to integer fils for shadow comparison.                      |
...
| staging-only receivables rehearsal rows                   | 2 excluded rows             | excluded from backend totals authority comparison | 0.00  | MATCH           | P0-008E receivables shadow evidence rows are isolated from backend totals switch comparison. |
| arrears outstanding                                       | 2690.00                     | 2690.00                                           | 0.00  | BLOCKED         | Interim shadow only; final authority blocked by P0-008 receivables.                          |
