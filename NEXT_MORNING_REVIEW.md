...
| P0-008 Receivables model       | Partial  | `RECEIVABLES_SOURCE_OF_TRUTH.md`, `modules/finance/receivables.mjs`, `tests/receivables.spec.mjs`, `tests/receivables-staging-shadow-gate.spec.mjs`, `STAGING_RECEIVABLES_SHADOW_COMPARISON_RESULT.md`, `P0_008D_DASHBOARD_RECEIVABLES_AUTHORITY_EVIDENCE.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Staging shadow gate passed; still needs more staging data, accounting review, and human approval before any active migration. |
