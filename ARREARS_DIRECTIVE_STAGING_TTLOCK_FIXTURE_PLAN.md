...
| source_ref | QA-TTLOCK-CARD-001-20260601122116 | Traceable staging-only source reference. |
...
| due_date | 2026-05-29 | Expired before current date. |
| qa_tag | ARREARS_TTLOCK_E2E_QA_20260601122116 | Findable QA trace and rollback scope. |
