...
test("scaffold does not implement runtime integration or legacy behavior", async () => {
  ...
  const sidecarMainForbidden = /\b(?:fetch|sessionStorage|XMLHttpRequest)\b|\/api\/|employee-v3|canonical(?!_anchor_count|_write_path|WritePath)|finance|ttlock|correction|reversal/i;
