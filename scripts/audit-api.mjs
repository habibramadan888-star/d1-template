...
const routeCatalog = {
  ...
  "ANY /": {
    purpose: "three-portal static entry",
    login: "No",
    roles: "public",
    tenantScope: "none",
    reads: "static asset",
    ...
    audit: "No",
    risk: "P2",
    notes: "Formal user entry; Worker handler serves static portal only for GET."
  },
  "ANY /home": {
    purpose: "three-portal static entry alias",
    login: "No",
    roles: "public",
    tenantScope: "none",
    reads: "static asset",
    ...
    audit: "No",
    risk: "P3",
    notes: "Alias to root entry; Worker handler serves static portal only for GET."
  },
  "ANY /login": {
    purpose: "legacy login alias",
    login: "No",
    roles: "public",
    tenantScope: "none",
    reads: "none",
    ...
    audit: "No",
    risk: "P2",
    notes: "Redirects to root entry; no credentials processed on this path."
  },
  "ANY /unified-login.html": {
    purpose: "legacy unified login alias",
    login: "No",
    roles: "public",
    tenantScope: "none",
    reads: "none",
    ...
    audit: "No",
    risk: "P2",
    notes: "Redirects to root entry; kept for compatibility only."
  },
  "ANY /employee-login": {
    purpose: "employee portal alias",
    login: "No",
    roles: "public",
    tenantScope: "none",
    reads: "none",
    ...
    audit: "No",
    risk: "P2",
    notes: "Redirects to root entry with employee portal selection."
  },
  "ANY /staff-login": {
    purpose: "staff portal alias",
    login: "No",
    roles: "public",
    tenantScope: "none",
    reads: "none",
  ...
  "ANY /employee.html": {
    purpose: "legacy employee login asset alias",
    login: "No",
    roles: "public",
    tenantScope: "none",
    reads: "none",
  ...
  "ANY /owner-login": {
    ...
    audit: "No",
    risk: "P2",
    notes: "Redirects to root entry with owner portal selection."
  },
  "ANY /admin-login": {
    purpose: "readonly admin portal alias",
    login: "No",
    roles: "public",
    tenantScope: "none",
    reads: "none",
    ...
    audit: "No",
    risk: "P2",
    notes: "Redirects to root entry with admin portal selection."
  },
  "ANY /employee-v3.html": {
    purpose: "legacy employee business asset alias",
    login: "Yes",
    roles: "employee",
    tenantScope: "session `corpid`",
    reads: "session",
    ...
    audit: "No",
    risk: "P2",
    notes: "Redirects to canonical `/employee`; no business write occurs."
  },
  "ANY /employee-v2.html": {
    purpose: "legacy employee business asset alias",
    login: "Yes",
    roles: "employee",
    tenantScope: "session `corpid`",
  ...
  "ANY /employee": {
    ...
    roles: "employee",
    tenantScope: "session `corpid`",
    reads: "session, static asset",
    writes: "none",
    financial: "No",
    delete: "No",
    audit: "No",
    risk: "P2",
    notes: "Serves employee asset only after server role check."
  },
  "ANY /owner": {
    purpose: "owner business page",
    login: "Yes",
    roles: "owner",
    tenantScope: "session `corpid`",
    reads: "session, static asset",
    ...
    audit: "No",
    risk: "P2",
    notes: "Serves owner asset only after server role check."
  },
  "ANY /admin": {
    purpose: "readonly admin business page",
    login: "Yes",
    ...
    audit: "No",
    risk: "P2",
    notes: "Serves owner asset in read-only mode after readonly admin role check."
  },
  "ANY /api/me": {
