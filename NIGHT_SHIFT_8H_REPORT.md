...
| D - P0-008A Receivables model design    | Completed   | pending   | `audit:db`, `check`, `smoke:with-worker`, `verify:clean-d1` PASS                                                                                                | Added receivables model design, lifecycle test plan, and draft SQL. P0-008 remains Partial.                          |
