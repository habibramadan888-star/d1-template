...
| --------------------------------------- | ----------- | ------- | ------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| A - P0-001B Money shadow validation     | Completed   | pending | `check`, `test:money`, `test:money-shadow`, `audit:money`, `reconcile:money`, `smoke:with-worker`, `verify:clean-d1` PASS | Added read-only local D1 shadow reconciliation. P0-001 remains Partial. |
| B - P0-003A Backend totals shadow audit | Not started | -       | -                                                                                                                         | Pending Stage A commit.                                                 |
