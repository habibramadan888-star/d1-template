...
| E - P0-006A Tenant isolation audit      | Completed   | pending   | `check`, `smoke:with-worker` PASS                                                                                                                              | Added tenant scope audit, migration plan, and cross-tenant test plan. P0-006 remains Partial.                        |
