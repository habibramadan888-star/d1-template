...
| -------: | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ---------------- |
|        1 | Review TOP_25 money risks                        | `RAMADAN_TOP_25_MONEY_RISK_DECISION_SHEET.md`; `RAMADAN_MONEY_RISK_DECISION_INPUT_TEMPLATE.md`                | Fill one decision and reason for each TOP_25 risk item.                         | PENDING_REVIEW   |
