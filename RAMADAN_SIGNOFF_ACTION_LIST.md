...
| -------: | ------------------------------------------------ | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ---------------- |
|        1 | Review TOP_25 money risks                        | `COMMERCIAL_LAUNCH_REVIEW_010_REMAINING_NO_GO_BLOCKERS.md`                                     | Close, reject, or explicitly accept each residual risk.                         | MANUAL_REQUIRED  |
|        2 | Review money reconciliation                      | `FINAL_PRODUCTION_APPROVAL_CHECKLIST.md`; copy reconciliation evidence                         | Decide whether copy money evidence is acceptable for production preflight.      | PENDING_REVIEW   |
