...
| P0-006 | Tenancy                  | Tenant isolation / static CORPID not SaaS-safe                                       | P0 launch blocker | Partial  | No         | Tenant/property local-staging rehearsal passed        | `TENANCY_SCOPE_AUDIT.md`, `TENANCY_MIGRATION_PLAN.md`, `TENANCY_TEST_PLAN.md`, `AUTH_TENANCY_AUDIT.md`, `P0_006B_TENANT_PROPERTY_SCOPE_READINESS_GATE.md`, `TENANT_SCOPE_LOCAL_STAGING_REHEARSAL_RESULT.md`, `P0_006C_DASHBOARD_HISTORY_EVIDENCE.md`, `modules/tenant/scope.mjs`, `tests/tenant-scope-local-staging.spec.mjs`, `scripts/rehearse-tenant-scope-local-staging.mjs`, `deploy-worker/wrangler.toml` has `CORPID = "homelink"`                                                                                                                                                                                                                                                                                                                                                                                         | Future customers could share identity/data boundaries incorrectly if scaled without redesign; local/staging fixtures now prove cross-tenant denial, but live routes still rely on static deployment scope and legacy `corpid`  | Continue with P0-006D tenant scope staging shadow gate; do not execute production migration or remove legacy CORPID fallback until migration/backfill/dashboard evidence and human tenancy decisions are complete                                              |
