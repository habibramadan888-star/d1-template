...
| P0-008 | Receivables              | Receivables model not fully closed for rent, arrears, tail payments, follow-up       | P0 launch blocker | Partial  | No         | Receivables staging shadow rehearsal passed | `RECEIVABLES_SOURCE_OF_TRUTH.md`, `modules/finance/receivables.mjs`, `tests/receivables.spec.mjs`, `tests/receivables-staging-shadow-gate.spec.mjs`, `tests/receivables-staging-shadow-rehearsal.spec.mjs`, `scripts/compare-staging-receivables-shadow.mjs`, `scripts/seed-receivables-staging-shadow-data.mjs`, `STAGING_RECEIVABLES_SHADOW_COMPARISON_RESULT.md`, `P0_008E_DASHBOARD_RECEIVABLES_AUTHORITY_EVIDENCE.md`                                                                                                                                                                                                                                                                                                                                                                                                        | Live route and database do not yet guarantee receivable/payment/arrears consistency; staging rehearsal has no mismatch, two expected adjustment differences, and still needs accounting review | Continue with P0-008F staging authority switch gate only; do not wire production until P0-001/P0-003/P0-006 gates, accounting review, backup, rollback, migration, and deploy approval are ready |
