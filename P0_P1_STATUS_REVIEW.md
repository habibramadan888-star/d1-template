...
| P0-006 | Tenancy                  | Tenant isolation / static CORPID not SaaS-safe                                       | P0 launch blocker | Partial  | No         | Tenant scope staging backfill write passed            | `TENANCY_SCOPE_AUDIT.md`, `TENANCY_MIGRATION_PLAN.md`, `TENANCY_TEST_PLAN.md`, `AUTH_TENANCY_AUDIT.md`, `P0_006B_TENANT_PROPERTY_SCOPE_READINESS_GATE.md`, `TENANT_SCOPE_LOCAL_STAGING_REHEARSAL_RESULT.md`, `P0_006C_DASHBOARD_HISTORY_EVIDENCE.md`, `P0_006I2_BACKFILL_WRITE_RESULT.md`, `P0_006I2_AFTER_SNAPSHOT_AND_VERIFICATION.md`, `P0_006I2_POST_BACKFILL_DRY_RUN_RESULT.md`, `modules/tenant/scope.mjs`, `tests/tenant-scope-local-staging.spec.mjs`, `scripts/rehearse-tenant-scope-local-staging.mjs`, `deploy-worker/wrangler.toml` has `CORPID = "homelink"`                                                                                                                                                                                                                                                         | Future customers could share identity/data boundaries incorrectly if scaled without redesign; staging backfill scoped only approved compatibility columns, while live routes still rely on static deployment scope and legacy `corpid` | Continue with P0-006J staging verification for scoped data, cross-tenant leakage, and employee/owner access scope; do not execute production migration or remove legacy CORPID fallback                                                                        |
