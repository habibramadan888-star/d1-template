...
- Ranks 1, 19, and 22 are accepted as `FALSE_POSITIVE` non-money scan hits and
  removed from production-blocking money authority risks.
- Legacy AED-to-fils conversion, backend/session totals authority, deposit
  liability/refund handling, and receivables lifecycle/allocation remain
  `NEEDS_ACCOUNTING_DECISION`.
- SO-007 remains `PENDING_REVIEW`.
- Production deploy, production migration, production D1 write, dashboard
  authority switch, and production cutover remain `PRODUCTION_NO_GO`.

| Item | Question for Ramadan                                                                  | Evidence                                                                                                  | Recommended Decision                                                                                   | If Not Approved                                               |
| ---- | ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| 1    | Can ranks 1, 19, and 22 be closed as non-money static-scan hits?                      | `TOP_25_MONEY_RISKS_REVIEW_MATRIX.md` shows they are lock sorting, date formatting, and pagination count. | Closed as `FALSE_POSITIVE` in Ramadan first-pass review.                                               | Reopen only if later evidence shows money-authority impact.   |
