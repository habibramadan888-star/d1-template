...
| 8    | Is `Number(row?.balance                                                               |                                                                                                           | 0)` acceptable as legacy-derived input only?                                                           | Rank 23; deposit ledger migration plan.                       | Pending review; approve only if final fils balance reconciliation is required before authority switch. | Keep deposit ledger authority blocked. |
